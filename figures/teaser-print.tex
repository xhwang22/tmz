...
% Rejected round-35 reflow, retained only as an archive. Do not include in main.tex.
% The author-approved layout is exported to figures/teaser.pdf.
\begingroup
...
\node[anchor=north] at (4.59,7.15) {\includegraphics[width=1.38cm]{figures/teaser/source-street.png}};
\node[anchor=north] at (7.02,7.15) {\includegraphics[width=1.38cm]{figures/teaser/edit-a.png}};
\node[anchor=north] at (10.88,7.15) {\includegraphics[width=1.38cm]{figures/teaser/edit-b.png}};
