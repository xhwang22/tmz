...
then return the same critique format. A common generator performs one revision
...
external metrics. Existing benchmark outputs serve only as pipeline pilots;
their labels cannot assess the new outputs.
