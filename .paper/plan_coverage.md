...
| Four domain families and all 22 standards (§2.4) | Problem; full domain appendix | Fig1 artifact gallery, Tab2 taxonomy, Figs5/6 all-domain C1 | Planned scope and complete synthetic coverage, not 22 completed experiments |
| Evaluation standard defines a domain (§2.4) | Problem; domain appendix | Tab2 criteria; Figs5/6 all 22 rows; Figs8/10/11 diagnostic rows | Shared procedure, not one universal scorer; eight-domain diagnostics do not stand for full coverage |
...
| Existing H0 is not an admission prerequisite (§3.2 patch) | Introduction; problem; mining | Fig1 two feedback routes; Tab3 provenance | Missing labels define data work, not the algorithm |
...
| Agreement, abstention, independent new labels (§3.2 patch) | Annotation protocol; quantitative-display discussion | Fig8 three-denominator audit | Simulated raters provide no reliability evidence; new labels are not presumed better |
| H0/H1/H2/H3 (§3.3) | Problem; mining; annotation appendix | Fig1 evidence interface; Tab3; Fig9b fixture | Human dimensions are not inferred from H0 |
...
nine active simulated charts. Main Figure 2 restores the approved landscape design with C1 alignment and selection; main Table 1 retains the full comparator matrix.
